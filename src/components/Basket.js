  ...
  render() {
    return (
      <div className="basket">
        <img className="basket__img" src={`/icons/${this.props.item.icon}.svg`} alt={`${this.props.item.name}`}/>
        <p className="basket__text basket__text--title">{this.props.item.name}</p>
